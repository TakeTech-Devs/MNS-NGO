...
export const createGoverningHeader = (HeaderData) => async(dispatch) =>{
    try {
        ...
        const { data } = await axios.post(`/api/v1/goveringBody/create-goveringHeader`, HeaderData, config);
...
export const createGoverningBody = (bodyData) => async(dispatch) =>{
    try {
        ...
        const { data } = await axios.post(`/api/v1/goveringBody/create-goveringBody`, bodyData, config);
