...
export const homeServiceReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case UPDATE_MEMBER_HOME_REQUEST:
        case DELETE_MEMBER_HOME_REQUEST:
            return {
                ...state,
                loading: true,
            }
        case UPDATE_SERVICE_HOME_SUCCESS:
        case UPDATE_MEMBER_HOME_SUCCESS:
        case DELETE_MEMBER_HOME_SUCCESS:
            return {
                ...state,
                loading: false,
                isUpdated: action.payload,
        ...
        case UPDATE_MEMBER_HOME_FAIL:
        case DELETE_MEMBER_HOME_FAIL:
            return {
                ...state,
                loading: false,
                error: action.payload,
        ...
        case UPDATE_MEMBER_HOME_RESET:
        case DELETE_MEMBER_HOME_RESET:
            return {
                ...state,
                isUpdated: false,
            }
